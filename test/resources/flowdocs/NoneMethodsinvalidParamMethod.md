...
state "
      return '';" as ex86
state "
    System.debug('dd');" as ex87
state if42 <<choice>>
state "
      System.debug('if');" as ex88
state if43 <<choice>>
state "
      System.debug('elseif');" as ex89
state "
      System.debug('else');" as ex90
state "
    System.debug('ddd');" as ex91
state "For loop
Integer idx = 0" as for5
state if45 <<choice>>
state "
      System.debug('for');" as ex92
state " idx++" as ex93
state "
    Integer i = 0;" as ex94
...
state if47 <<choice>>
state "
          System.debug('i is less than 2');" as ex96
state "
          System.debug('i not is less than 2');" as ex97
state "
        System.debug('2');" as ex98
state "while loop" as while0
state if49 <<choice>>
state "
      System.debug(i);" as ex99
state "
      i++;" as ex100
[*] --> if0
ex0 --> ex1
